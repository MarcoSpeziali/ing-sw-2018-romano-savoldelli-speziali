...
class DecrementActionTest {

    private DecrementAction action;
    private Context context = Context.getSharedInstance();
    private ActionData testData = new ActionData("test", null, null);
    private Die die;
    ...
    void testNonProblematicDecrement() {
        Die before = this.die;
        action = new DecrementAction(this.testData, context -> this.die, context -> 2);
    ...
    void testProblematicDecrement() {
        Die before = this.die;
        action = new DecrementAction(this.testData, context -> this.die, context -> 3);
    ...
    void testProblematicDecrement2() {
        Die before = this.die;
        action = new DecrementAction(this.testData, context -> this.die, context -> 4);
    ...
    void testProblematicDecrement3() {
        Die before = this.die;
        action = new DecrementAction(this.testData, context -> this.die, context -> 6);
