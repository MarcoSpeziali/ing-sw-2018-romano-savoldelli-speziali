package it.polimi.ingsw.server.utils.collections;
...
public class BiHashMap<K1, K2, V> {
    ...
    private final Map<BiKey<K1, K2>, V> internalMap = new HashMap<>();
     ...
     * @param key2 the first key whose presence in this map is to be tested
     * @return {@code true} if this map contains a mapping for the specified
     * key pair
     * @throws ClassCastException   if the key pair is of an inappropriate type for
     *                              this map
     *                              (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     * @throws NullPointerException if the specified key pair is null and this map
     *                              does not permit null keys
     *                              (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    public boolean containsKey(K1 key1, K2 key2) {
        return this.internalMap.containsKey(biKey(key1, key2));
    }
    ...
    public V get(K1 key1, K2 key2) {
        return this.internalMap.get(biKey(key1, key2));
    }
     ...
     * if {@link #containsKey(K1, K2) m.containsKey(k1, k2)} would return
     * {@code true}.)
     *
     * @param key1   the first key with which the specified value is to be associated
     * @param key2   the second key with which the specified value is to be associated
    ...
    public V put(K1 key1, K2 key2, V value) {
        return this.internalMap.put(biKey(key1, key2), value);
    }
     ...
     * call returns.
     *
     * @param key1 the first key whose mapping is to be removed from the map
     * @param key2 the second key whose mapping is to be removed from the map
     * @return the previous value associated with {@code key}, or
     * {@code null} if there was no mapping for {@code key}.
    ...
    public V remove(K1 key1, K2 key2) {
        return this.internalMap.remove(biKey(key1, key2));
    }
    
    /**
     * Copies all of the mappings from the specified map to this map
     * (optional operation).  The effect of this call is equivalent to that
     * of calling {@link #put(K1, K2, V) put(k1, k2, v)} on this map once
     ...
     */
    public void putAll(BiHashMap<? extends K1, ? extends K2, ? extends V> m) {
        m.forEach(this::put);
    }
     ...
     */
    public Set<Map.Entry<BiKey<K1, K2>, V>> entrySet() {
    ...
    public V getOrDefault(K1 key1, K2 key2, V defaultValue) {
        return this.internalMap.getOrDefault(biKey(key1, key2), defaultValue);
    }
    ...
    public void forEach(TriConsumer<? super K1, ? super  K2, ? super V> action) {
        this.internalMap.forEach((biKey, v) -> action.accept(biKey.key1, biKey.key2, v));
    }
    ...
    public void replaceAll(TriFunction<? super K1, ? super K2, ? super V, ? extends V> function) {
        this.internalMap.replaceAll((biKey, v) -> function.apply(biKey.key1, biKey.key2, v));
    }
    ...
    public V putIfAbsent(K1 key1, K2 key2, V value) {
        return this.internalMap.putIfAbsent(biKey(key1, key2), value);
    }
     ...
     *
     * @param key1   the first key with which the specified value is associated
     * @param key2   the second key with which the specified value is associated
    ...
    public boolean remove(K1 key1, K2 key2, V value) {
        return this.internalMap.remove(biKey(key1, key2), value);
    }
    ...
    public boolean replace(K1 key1, K2 key2, V oldValue, V newValue) {
        return this.internalMap.replace(biKey(key1, key2), oldValue, newValue);
    }
     ...
     * @since 1.8
     */
    public V replace(K1 key1, K2 key2, V value) {
        return this.internalMap.replace(biKey(key1, key2), value);
    }
    ...
    public V computeIfAbsent(K1 key1, K2 key2, BiFunction<? super K1, ? super K2, ? extends V> mappingFunction) {
        return this.internalMap.computeIfAbsent(
                biKey(key1, key2),
                biKey -> mappingFunction.apply(biKey.key1, biKey.key2)
        );
    }
     ...
     * @since 1.8
     */
    public V computeIfPresent(K1 key1, K2 key2, TriFunction<? super K1, ? super K2, ? super V, ? extends V> remappingFunction) {
        return this.internalMap.computeIfPresent(
                biKey(key1, key2),
                (biKey, v) -> remappingFunction.apply(biKey.key1, biKey.key2, v)
        );
    }
     ...
     * @since 1.8
     */
    public V compute(K1 key1, K2 key2, TriFunction<? super K1, ? super K2, ? super V, ? extends V> remappingFunction) {
        return this.internalMap.compute(
                biKey(key1, key2),
                (biKey, v) -> remappingFunction.apply(biKey.key1, biKey.key2, v)
        );
    }
     ...
     * <p>The remapping function should not modify this map during computation.
     *
     * @param key1   the first key with which the resulting value is associated
     * @param key2   the second key with which the resulting value is associated
    ...
    public static class BiKey<K1, K2> {
        ...
        public boolean equals(Object o) {
            ...
            BiKey<?, ?> biKey = (BiKey<?, ?>) o;
            return Objects.equals(key1, biKey.key1) &&
                    Objects.equals(key2, biKey.key2);
        }
