...
public class EffectInstantiator {

    private EffectInstantiator() {
    }
                    ...
                    .map(compiledExecutableAction -> {
                        ...
                        try {
                            if (compiledExecutableAction.getClassToInstantiate().equals(ActionGroup.class)) {
                                return ActionGroupInstantiator.instantiate((CompiledActionGroup) compiledExecutableAction);
                            }
                            else {
                                return ActionInstantiator.instantiate((CompiledAction) compiledExecutableAction);
                            }
                        }
