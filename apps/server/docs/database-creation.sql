...
CREATE TABLE IF NOT EXISTS pre_authentication_session (
  ...
  invalidation_time TIMESTAMP NOT NULL DEFAULT current_timestamp + INTERVAL '2 minutes',
...
CREATE TABLE IF NOT EXISTS session (
  id SERIAL PRIMARY KEY,
  creation_time TIMESTAMP NOT NULL DEFAULT current_timestamp,
  invalidation_time TIMESTAMP NOT NULL DEFAULT current_timestamp + INTERVAL '12 hours',
