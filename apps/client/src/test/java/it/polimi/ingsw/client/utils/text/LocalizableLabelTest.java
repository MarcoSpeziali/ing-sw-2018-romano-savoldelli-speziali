...
class LocalizableLabelTest extends JavaFXBaseTest {
    ...
    @LocalizedText(key = "localizable_label.test.label1", fieldUpdater = LabeledLocalizationUpdater.class)
    private Label label1 = new Label("pre_update");

    @LocalizedText(key = "localizable_label.test.label2", fieldUpdater = LabeledLocalizationUpdater.class)
